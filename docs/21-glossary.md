...
### Middleware
Function executed before a request handler in FastAPI. Used for logging, authentication, etc.
...
### FastAPI
Node.js framework for building server-side applications. The OpenWA backend is built with FastAPI.

### Node.js
JavaScript runtime used to run OpenWA. Supported version: Python Python & Node.js Node.js.

## O

### ORM (Object-Relational Mapping)
Library that maps objects in code to database tables. OpenWA uses SQLAlchemy.
