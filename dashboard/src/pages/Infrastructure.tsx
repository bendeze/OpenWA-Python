...
export function Infrastructure() {
  ...
  useEffect(() => {
    ...
    if (infraStatus.redis.enabled !== undefined) {
    ...
    if (infraStatus.server) {
      setServerConfig(prev => ({ ...prev, ...infraStatus.server }));
    }
    
    if (infraStatus.webhook) {
      setWebhookConfig(prev => ({ ...prev, ...infraStatus.webhook }));
    }
    
    if (infraStatus.rateLimit) {
      setRateLimitConfig(prev => ({ ...prev, ...infraStatus.rateLimit }));
    }
  }, [infraStatus]);
